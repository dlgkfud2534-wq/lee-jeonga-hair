export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white/50 py-12 md:py-16 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-10">
          ...
          {/* Contact & SNS */}
          <div>
            <h4 className="text-[11px] font-semibold text-white tracking-[0.2em] uppercase mb-4">연락처</h4>
            <div className="space-y-2 text-sm text-white/30 mb-6">
              <p>{address}</p>
              <p>{phone}</p>
              <p>{email}</p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <a
                href="#"
                className="w-9 h-9 border border-white/10 hover:border-accent hover:text-accent flex items-center justify-center transition-colors"
